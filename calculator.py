...
#          / ____|    | |          | |     | |      (_)          |  _ \        |___  /                              
#         | |     __ _| | ___ _   _| | __ _| |_ _ __ _  ___ ___  | |_) |_   _     / / ___ _   _ _ __   _____      __
#         | |    / _` | |/ __| | | | |/ _` | __| '__| |/ __/ _ \ |  _ <| | | |   / / / _ \ | | | '_ \ / _ \ \ /\ / /
#         | |___| (_| | | (__| |_| | | (_| | |_| |  | | (_|  __/ | |_) | |_| |  / /_|  __/ |_| | | | | (_) \ V  V / 
#          \_____\__,_|_|\___|\__,_|_|\__,_|\__|_|  |_|\___\___| |____/ \__, | /_____\___|\__, |_| |_|\___/ \_/\_/  
#                                                                        __/ |             __/ |                    
#                                                                       |___/             |___/                     
...
class Calculator():
    def __init__(self):
        ...
        self.text = ""
        self.signe = ""
        self.entry.set("Crée par: Zeynow | Version: 1.0")
...
BC = Button(fen, text="C", command=ButtonC, width=3, height=2, bg="white", fg="red", relief=RIDGE).place(x=10, y=190) 
...
BP = Button(fen, text="+", command=ButtonP, width=4, height=2, bg="white", fg="black", relief=GROOVE).place(x=150, y=40) 
BS = Button(fen, text="-", command=ButtonS, width=4, height=2, bg="white", fg="black", relief=GROOVE).place(x=150, y=80) 
BD = Button(fen, text="/", command=ButtonD, width=4, height=2, bg="white", fg="black", relief=GROOVE).place(x=150, y=120) 
BM = Button(fen, text="X", command=ButtonM, width=4, height=2, bg="white", fg="black", relief=GROOVE).place(x=150, y=160) 
